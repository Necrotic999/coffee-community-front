    ...
    <section className="relative">
      <header className="absolute w-full bg-black/40 rounded-b-xl h-[60px] min-[768px]:h-[88px] min-[1440px]:h-[120px] pt-1.5 mb-6">
        ...
        >
          ...
          <button className="group col-start-3 min-[768px]:col-start-4 min-[1440px]:col-start-6 cursor-pointer">
            <Image
              className="fill-[#D9D9D9] min-[1440px]:group-hover:text-[#FF9305] min-[768px]:w-[30px] min-[768px]:h-[30px] min-[1440px]:w-10 min-[1440px]:h-10"
